...
export default async function AdminJogosPage({
  ...
  const { data: jogosData } = await supabase
    .from("jogos")
    .select(
      "id, campeonato_id, categoria, serie, equipe_mandante_nome, equipe_visitante_nome, data_jogo, horario, local, rodada, gols_mandante, gols_visitante, status, observacoes, created_at"
    )
                  ...
                  >
                    ...
                    <div className="mt-5 grid gap-3 md:grid-cols-[1fr_auto_auto]">
                      ...
                      >
                        ...
                        <button
                          type="submit"
                          className="inline-flex items-center justify-center gap-2 rounded-2xl bg-green-300 px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-slate-950"
                        >
